...
if(isset($aspire_Options['blog-page-layout']))
{
$design = $aspire_Options['blog-page-layout'];
}
else
{
$design=''; 
...
?>
  <?php magikAspire_layout_breadcrumb();?>
...
<div class="blog-wrapper <?php echo esc_html($main) ?>">
  ...
  <div class="<?php echo esc_html($col); ?>">
    ...
    <h2><?php printf( esc_html__( 'Search Results for: %s', 'aspire' ), esc_html( get_search_query())); ?>
                 ...
                 <ul class="list-info">
                  ...
                  <div class="post-img <?php if (has_post_thumbnail()){?> has-img <?php } ?>">
                    ...
                    <a title="<?php the_title(); ?>" href="<?php the_permalink(); ?>">
                       <figure>
                      <?php
                        the_post_thumbnail('magikAspire-article-home-large', array('class' => 'img-responsive', 'alt' => esc_html(get_the_title())));
                      ?>
                       </figure>
                    </a>
                    <?php endif;
                     ...
                     <?php echo get_the_excerpt(); ?>    
                      ...
                      ?>
                        <a href="<?php the_permalink(); ?>" class="btn-mega">
                                            <?php esc_attr_e('Read More', 'aspire') ?>
                                        </a>
        ...
        <?php else: ?>
          <div><?php esc_attr_e("Sorry, What you are looking isn't here.",'aspire') ;?>. </div>
        <?php endif; ?>
      </div>
      </div>
      </div>
