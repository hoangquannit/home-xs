...
global $product, $woocommerce_loop, $yith_wcwl,$aspire_Options;
...
<div class="item-inner">
       ...
       <?php endif; ?>
                  ...
                  <a title="<?php esc_attr_e('Quick View', 'aspire'); ?>" class="yith-wcqv-button quickview link-quickview" data-product_id="<?php echo esc_html($product->get_id()); ?>"><?php esc_attr_e('Quick View', 'aspire'); ?></a>
                </li>
                  <?php } ?>
        ...
        <li><a href="<?php echo esc_url( add_query_arg( 'add_to_wishlist', $product->get_id() ) ) ?>"
           ...
           title="<?php esc_attr_e('WishList','aspire'); ?>"><?php esc_attr_e('WishList','aspire'); ?></a>
         </li>
<?php
    }
    ?>
    <?php
      if (class_exists('YITH_Woocompare_Frontend')) {
        ...
        <li><a class="compare add_to_compare_small link-compare" data-product_id="<?php echo esc_html($product->get_id()); ?>"
           href="<?php echo esc_url($mgk_yith_cmp->add_product_url($product->get_id())); ?>" title="<?php esc_attr_e('Compare','aspire'); ?>"><?php esc_attr_e('Compare','aspire'); ?></a>
         </li>
<?php
    }
     ?>              
