    ...
    if ( ( ! is_home() && ! is_front_page() && ! (is_post_type_archive()) ) || is_paged() ) {
        ...
        if ( is_home() ) {
           echo htmlspecialchars_decode(single_post_title('', false));
            ...
            echo htmlspecialchars_decode(esc_html__( 'Search results for &ldquo;', 'aspire' ) . get_search_query() . '&rdquo;');

        } elseif ( is_tag() ) {

            echo htmlspecialchars_decode(esc_html__( 'Posts tagged &ldquo;', 'aspire' ) . single_tag_title('', false) . '&rdquo;');

        } elseif ( is_author() ) {

            $userdata = get_userdata($author);
            echo htmlspecialchars_decode(esc_html__( 'Author:', 'aspire' ) . ' ' . $userdata->display_name);
        ...
        if ( get_query_var( 'paged' ) ) {
            echo htmlspecialchars_decode( ' (' . esc_html__( 'Page', 'aspire' ) . ' ' . get_query_var( 'paged' ) . ')');
        }
    } else {
  ...
  // breadcrumb code
    ...
    if ( ( ! is_home() && ! is_front_page() && ! (is_post_type_archive()) ) || is_paged() ) {
        ...
        elseif ( is_day() ) {
            ...
            echo htmlspecialchars_decode($before .$linkbefore. esc_html__( 'Error 404', 'aspire' ) .$linkafter. $after);
            ...
            echo htmlspecialchars_decode($before .$linkbefore. esc_html__( 'Search results for &ldquo;', 'aspire' ) . get_search_query() . '&rdquo;' .$linkafter. $after);
            ...
            echo htmlspecialchars_decode($before .$linkbefore. esc_html__( 'Posts tagged &ldquo;', 'aspire' ) . single_tag_title('', false) . '&rdquo;' .$linkafter. $after);

        } elseif ( is_author() ) {

            $userdata = get_userdata($author);
            echo htmlspecialchars_decode($before .$linkbefore. esc_html__( 'Author:', 'aspire' ) . ' ' . $userdata->display_name .$linkafter. $after);
        ...
        if ( get_query_var( 'paged' ) ) {
            echo htmlspecialchars_decode($before .$linkbefore. '&nbsp;(' . esc_html__( 'Page', 'aspire' ) . ' ' . get_query_var( 'paged' ) . ')' .$linkafter. $after);
        }
