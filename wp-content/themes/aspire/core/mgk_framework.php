...
require_once(MAGIKASPIRE_THEME_PATH . '/core/resize.php');
require_once(MAGIKASPIRE_THEME_PATH . '/includes/mgk_menu.php');
require_once(MAGIKASPIRE_THEME_PATH . '/includes/widget.php');
require_once(MAGIKASPIRE_THEME_PATH . '/includes/mgk_widget.php');
...
if ( ! function_exists( 'magikAspire_wp_trim_excerpt' ) ) : 
    function magikAspire_wp_trim_excerpt($wpse_excerpt) {
    $raw_excerpt = $wpse_excerpt;
        if ( '' == $wpse_excerpt ) {
            ...
            $wpse_excerpt = strip_tags($wpse_excerpt, magikAspire_allowedtags()); /*IF you need to allow just certain tags. Delete if all tags are allowed */
        ...
        return apply_filters('magikAspire_wp_trim_excerpt', $wpse_excerpt, $raw_excerpt);
    }

endif; 

remove_filter('get_the_excerpt', 'wp_trim_excerpt');
add_filter('get_the_excerpt', 'magikAspire_wp_trim_excerpt');
...
function magikAspire_footer_text()
{
    ...
    if (isset($aspire_Options['bottom-footer-text']) && !empty($aspire_Options['bottom-footer-text'])) {
      ...
      <div class="row">
      <?php
      echo htmlspecialchars_decode ($aspire_Options['bottom-footer-text']);
      ?>
      </div>
      </div>
    </div>
